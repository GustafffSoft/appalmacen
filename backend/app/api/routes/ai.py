...
async def sales_message(request: GenerateSalesMessageRequest) -> GenerateSalesMessageResponse:
    try:
        ...
        raise HTTPException(status_code=500, detail=f"AI sales message failed: {exc}") from exc
